...
public class PatientList extends AppCompatActivity implements onItemClickListener{

    private List<User> userList = new ArrayList<>();
    private RecyclerView recyclerView;
    private PatientListAdeptar mAdapter;
    Button add_user ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PatientList.this, AddUser.class);
        ...
        mAdapter = new PatientListAdeptar(userList, this);
    ...
    private void prepareUserData() throws JSONException {
        ...
        String url = "http://10.0.2.2:8000/patient_list/";
        final ProgressDialog pd = new ProgressDialog(PatientList.this);
