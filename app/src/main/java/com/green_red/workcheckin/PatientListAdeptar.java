...
public class PatientListAdeptar extends RecyclerView.Adapter<PatientListAdeptar.MyViewHolder>{

    private List<User> userList;
    public onItemClickListener listener;

    public PatientListAdeptar(List<User> userList, onItemClickListener listener) {
